function tambahTelpLagi(control){
	...
	if(no_telp == ''){
		...
		$(control).closest('#no_telp_container')
			.append("<div class='input-group'><input name='no_telp[]' class='form-control' type='text'> <div class='input-group-btn'><button type='button' onclick='tambahTelpLagi(this);return false;' class='btn btn-success btn-block'><strong><span class='glyphicon glyphicon-plus'></span></strong></button></div></div>");
		$(control)
			.removeAttr('class')
